...
p favorite_color({color: 'blue'})
p favorite_number({number: 41})
p update_favorite_movie({favorite_movie: "Ferris Bueller's Day Off"}, 'Perfect Blue')
p remove_favorite_number({number: 41})
p favorite_categories({color: 'blue'})
p favorite_items({number: 41})
p merge_favorites({color: 'blue'}, {color: 'red', favorite_movie: 'The Breakfast Club'})